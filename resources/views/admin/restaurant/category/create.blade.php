                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="form-group col-md-4">
                                ...
                                <x-image-uploader :imagePath="getImage(null, getFileSize('restaurant_category'))" :size="getFileSize('restaurant_category')" class="w-100" id="imageInput" name="image_input" :required="true" />
                            </div>
                            <div class="col-md-8">
...
@push('breadcrumb-plugins')
    <x-back route="{{ route('admin.restaurant.category.index') }}" />
@endpush
