...
@section('panel')
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                <form action="{{ route('admin.restaurant.category.store', $category->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="card-body">
                        <div class="row">
                            <div class="form-group col-md-4">
                                <label>@lang('Image')</label>
                                <x-image-uploader :imagePath="getImage(getFilePath('restaurant_category') . '/' . $category->image, getFileSize('restaurant_category'))" :size="getFileSize('restaurant_category')" class="w-100" id="imageInput" name="image_input" :required="false" />
                            </div>
                            <div class="col-md-8">
