                    ...
                    <form method="POST">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-4 col-sm-6">
                                <div class="form-group">
                                    <label>
                                        @lang('Fee per Job Post')
                                        <i class="las la-info-circle" data-toggle="tooltip" data-placement="top"
                                            title="@lang('If a user doesn\'t purchase any plan, if the plan has expired, or if the job post limit has been reached, then this fee will apply to each job post.')"></i>
                                    </label>
                                    <div class="input-group">
                                        <input class="form-control" type="text" name="fee_per_job_post"
                                            value="{{ getAmount(gs('fee_per_job_post')) }}" required>
                            ...
                            <div class="col-xl-4 col-sm-6">
                                <div class="form-group">
                                    <label>
                                        @lang('Free Job Post Limit')
                                        <i class="las la-info-circle" data-toggle="tooltip" data-placement="top"
                                            title="@lang('If a user doesn\'t purchase any plan, then how many times a user can post job for free.')"></i>
                                    </label>
