        ...
        <div class="col-lg-12">
            <div class="card">
                <form method="post">
                    ...
                    <div class="card-body">
                        <ul class="list-group">
                            <li class="list-group-item flex-sm-nowrap gap-2">
                                <div>
                                    <p class="fw-bold mb-0">@lang('User Registration')</p>
                                    <p class="mb-0">
                                        <small>@lang('If you disable this module, no one can register on this system as a user.')</small>
                                    </p>
                                </div>
                            ...
                            <li class="list-group-item flex-sm-nowrap gap-2">
                                ...
                                <div class="form-group">
                                    <input type="checkbox" data-width="100%" data-size="large" data-onstyle="-success"
                                        data-offstyle="-danger" data-bs-toggle="toggle" data-height="35"
                                        data-on="@lang('Enable')" data-off="@lang('Disable')" name="User_registration"
                                        @if (gs('User_registration')) checked @endif>
                                </div>
                            </li>
                            <li class="list-group-item flex-sm-nowrap gap-2">
                                <div>
                                ...
                                <div>
                                    ...
                                    <p class="mb-0">
                                        <small>
                                            ...
                                            <a href="{{ route('admin.frontend.sections', 'policy_pages') }}">
                                                @lang('policies')
                                            </a>
                                ...
                                <div>
                                    ...
                                    <p class="mb-0">
                                        <small>
                                            ...
                                            <a href="{{ route('admin.setting.notification.push') }}" target="_blank">@lang('Setting here')</a>
                                        </small>
                                    </p>
                                </div>
                                <div class="form-group">
