...
@section('panel')
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                <form action="{{ route('admin.room.category.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="card-body">
                        <div class="row">
                            <div class="form-group col-md-4">
                                <label>@lang('Image')</label>
                                <x-image-uploader :imagePath="getImage(null, getFileSize('room_category'))" :size="getFileSize('room_category')" class="w-100" id="imageInput" name="image_input" :required="true" />
                            </div>
                            <div class="col-md-8">
