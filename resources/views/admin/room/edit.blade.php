        ...
        <div class="row">
            <div class="col-lg-4">
                        ...
                        {{-- <div class="form-group">
                            ...
                            <select name="category_id" class="form-control">
                                ...
                                @foreach ($categories as $category)
                                    <option value="{{ $category->id }}" @selected(@$room->category_id == $category->id)>
                                        {{ __($category->t->name) }}</option>
                                @endforeach
                            </select>
                        </div> --}}
                        <div class="form-group">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="row" id="gallery-container">
                            @if (@$room->mainImages)
                                @foreach ($room->mainImages as $img)
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <div class="row" id="intro-gallery-container">
                            @if (@$room->introImages)
                                @foreach ($room->introImages as $img)
                                    <div class="col-md-6 mb-3 gallery-item">
                                        <div class="position-relative">
                                            <img src="{{ getImage(getFilePath('room') . '/' . $img->image) }}"
                                                class="img-thumbnail w-100">
                                ...
                                <div class="tab-pane fade @if($loop->first) show active @endif" id="{{ $lang->code }}" role="tabpanel"
                                    aria-labelledby="{{ $lang->code }}-tab">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control name-input"
                                                        ...
                                                        data-lang="{{ $lang->code }}" value="{{ old('translations.' . $lang->code . '.name', @$translation->name ?: ($lang->code == 'en' ? @$room->name : '')) }}"
                                                        required>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control slug-input"
                                                        ...
                                                        data-lang="{{ $lang->code }}" value="{{ old('translations.' . $lang->code . '.slug', @$translation->slug ?: ($lang->code == 'en' ? @$room->slug : '')) }}"
                                                        required>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" name="translations[{{ $lang->code }}][description]">{{ old('translations.' . $lang->code . '.description', @$translation->description ?: ($lang->code == 'en' ? @$room->description : '')) }}</textarea>
                                        </div>
                                        <div class="form-group">
                                            <label>@lang('Content')</label>
                                            <textarea class="form-control nicEdit" name="translations[{{ $lang->code }}][content]">{{ old('translations.' . $lang->code . '.content', @$translation->content ?: ($lang->code == 'en' ? @$room->content : '')) }}</textarea>
                                        </div>

                                        <x-repeater :lang="$lang->code" :items="@$translation->additional_info" />


                                        <div class="row card bg--light mb-3 p-3 mx-0"style="flex-direction: row !important">
