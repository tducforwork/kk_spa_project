            ...
            <div class="row  mb-4 justify-content-center">
                <div class="col-sm-7">
                    <div class="row gy-4 justify-content-center">
                        <div class="col-sm-6">
                            <x-widget link="javascript:void(0)" style="6" icon="fas fa-list" :title="$viaText . ' should be sent'"
                                value="{{ @$sessionData['total_User'] }}" bg="primary" :viewMoreIcon=false />
                        </div>
                        <div class="col-sm-6">
                            <x-widget link="javascript:void(0)" style="6" icon="fa-solid fa-envelope-circle-check"
                                :title="$viaText . ' has been sent'" value="{{ @$sessionData['total_sent'] }}" bg="success"
                                :viewMoreIcon=false />
                        </div>
                        <div class="col-sm-6">
                            <x-widget link="javascript:void(0)" style="6" icon="fa-solid fa-paper-plane" :title="$viaText . ' has yet to be sent'"
                                :viewMoreIcon=false value="{{ @$sessionData['total_User'] - @$sessionData['total_sent'] }}"
                                bg="warning" />
                        </div>
                        <div class="col-sm-6">
                            <x-widget link="javascript:void(0)" style="6" icon="fas fa-envelope" :title="$viaText . ' per batch'"
                                ...
                                <div class="row">
                                    @if (gs('en'))
                                        <div class="col-xxl-2 col-xl-3 col-lg-4 col-md-3 col-sm-6">
                                            <div class="notification-via mb-4  @if ($viaName == 'email') active @endif "
                                                data-method="email">
                                    ...
                                    @if (gs('sn'))
                                        <div class="col-xxl-2 col-xl-3 col-lg-4 col-md-3 col-sm-6">
                                            <div class="notification-via mb-4 @if ($viaName == 'sms') active @endif "
                                                data-method="sms">
                                                <span class="active-badge"> <i class="las la-check"></i> </span>
                                                <div class="send-via-method">
                                    ...
                                    @if (gs('pn'))
                                        <div class="col-xxl-2 col-xl-3 col-lg-4 col-md-3 col-sm-12">
                                            <div class="notification-via mb-4 @if ($viaName == 'push') active @endif"
                                                data-method="push">
                                                <span class="active-badge"> <i class="las la-check"></i> </span>
                                                <div class="send-via-method">
    ...
    (function($) {
        ...
        $('select[name=being_sent_to]').on('change', function(e) {
            ...
            if (methodName == 'TOPDEPOSITEDUserS') {
                $('.input-append').html(`
                    <div class="form-group">
                        <label class="required">@lang('Number Of Top Payment User')</label>
        ...
        $('.notification-via').on('click', function() {
            ...
            if ($(this).data('method') == 'email') {
                $('.nicEdit').closest('.form-group').show();
                // Re-initialize CKEditor if destroyed
                ...
                $('.nicEdit').closest('.form-group').hide();
            }
