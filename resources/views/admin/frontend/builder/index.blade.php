                ...
                <form action="{{ route('admin.frontend.manage.pages.update') }}" method="POST">
                    ...
                    <div class="card mb-3">
                        <div class="card-header bg--dark">
                            <ul class="nav nav-tabs card-header-tabs" id="pageTab" role="tablist">
                        ...
                        <div class="card-body">
                            <div class="tab-content" id="pageTabContent">
                                @foreach($languages as $lang)
                                    @php $trans = $pData->translations->where('lang_code', $lang->code)->first(); @endphp
                                    <div class="tab-pane fade {{ $loop->first ? 'show active' : '' }}" id="{{ $lang->code }}" role="tabpanel">
                                        <div class="form-group">
                                            <label class="required">@lang('Page Name') ({{ strtoupper($lang->code) }})</label>
                                            <input type="text" class="form-control" name="translations[{{ $lang->code }}][name]" value="{{ @$trans->name }}" required>
                                        </div>
                                    </div>
                                @endforeach
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input class="form-control" name="name" type="text"
                                    value="{{ $pData->name }}" required placeholder="@lang('System fallback')">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
