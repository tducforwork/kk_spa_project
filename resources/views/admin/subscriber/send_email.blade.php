            ...
            <div class="row gy-4 justify-content-center">
                ...
                <div class="col-sm-6">
                    <x-widget link="javascript:void(0)" style="6" icon="fa-solid fa-envelope-circle-check"
                        title="Email has been sent" value="{{ @$sessionData['total_sent'] }}" bg="success"
                        :viewMoreIcon=false />
                </div>
                <div class="col-sm-6">
                    <x-widget link="javascript:void(0)" style="6" icon="fa-solid fa-paper-plane"
                        title="Email has yet to be sent" :viewMoreIcon=false
                        value="{{ @$sessionData['total_subscriber'] - @$sessionData['total_sent'] }}" bg="warning" />
                </div>
                <div class="col-sm-6">
